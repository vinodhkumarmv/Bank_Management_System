    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t2.getText().equals("")){
                ...
                Conn c1 = new Conn();
                String q1 = "insert into PersonalDetails values('"+formno+"','"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+pan+"','"+aadhar+"','"+scitizen+"','"+eaccount+"')";
